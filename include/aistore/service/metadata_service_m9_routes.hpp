#ifndef AISTORE_SERVICE_METADATA_SERVICE_M9_ROUTES_HPP
#define AISTORE_SERVICE_METADATA_SERVICE_M9_ROUTES_HPP
...
[[nodiscard]] std::optional<aistore::http::HttpResponse> try_handle_m9_routes(
    const aistore::http::HttpRequest& request, metadata::PostgresMetadataRepository& repository,
    std::mutex& repository_mutex);

}  // namespace aistore::service

#endif  // AISTORE_SERVICE_METADATA_SERVICE_M9_ROUTES_HPP
